...
define('_AM_CONTENT_ERRORUPL', 'Error while uploading file!');
define('_AM_CONTENT_PERMERROR', 'ERROR: The content directory is not writable.  Please chmod a+w the content directory.');
define('_AM_CONTENT_VIEWPERMTITLE', 'View Permissions');
define('_AM_CONTENT_VIEWPERMDESC', 'Allow users to view specific pages.  If you disable a top level page, it will not generate in the site menu');

// Added in pre ct
define('_AM_CONTENT_DISABLEBREAKS', 'Disable Linebreak Conversion (Activate when using HTML)');
define('_AM_CONTENT_SUBMENU', 'Submenu');

//Added in 1.0
define('_AM_CONTENT_COPYCONTENT', 'Are you sure you want to copy this page?');
define('_AM_CONTENT_NEWWINDOW', 'New Window');
define('_AM_CONTENT_COPY', 'Copy');
define('_AM_CONTENT_NONE', 'None');
define('_AM_CONTENT_ERROR', 'Error');
define('_AM_CONTENT_SELECTFILE', 'Select a File');
define('_AM_CONTENT_UPLOADFILE', 'Or Upload a File');
define('_AM_CONTENT_SELECTIMG', 'Select a header image');
define('_AM_CONTENT_UPLOADIMG', 'Or Upload an Image');
define('_AM_CONTENT_CNTTYP', 'Content Type');
define('_AM_CONTENT_GO', 'View');
define('_AM_CONTENT_UPGRADENOTICE', 'You need to upgrade your installation of Content.  Please use the <a href="upgrade.php">upgrade page</a>');
define('_AM_CONTENT_DBUPGRADED', 'Database upgraded to');
define('_AM_CONTENT_CREATED', 'Created');
define('_AM_CONTENT_PERMITREAD', 'Read Permissions');
define('_AM_CONTENT_PERMITWRITE', 'Write Permissions');
